...
public class PostController {
         ...
         */
        @GetMapping("/post")
        public ResponseEntity<List<PostSummary>> getFeed(@Parameter(
        ...
        public ResponseEntity<String> createPost(@RequestBody CreatePostRequest createPostRequest,
                ...
                CreatePostCommand createPostCommand = new CreatePostCommand(
                                createPostRequest.getContent(), userId,
                                createPostRequest.getRootPostId(), createPostRequest.getPostId());
        ...
        public Page<PostSummary> getPosts(@RequestParam(required = false) String keyword,
                ...
                if (size > 50)
                        size = 50;
                Page<Post> postPage = postService.getPosts(keyword, authorName, createdAfter,
                                createdBefore, sortBy, order, page, size);
        ...
        public ResponseEntity<UpdatePostResponse> updatePost(
                ...
                UpdatePostDto updatePostDto = new UpdatePostDto(updatePostRequest.getPostId(),
                                userId, updatePostRequest.getContent());
                ...
                if (updatePostResultDto.getUpdatePostResultStatus()
                        ...
                        return ResponseEntity.badRequest()
                                        .body(new UpdatePostResponse(false, "error"));
                }
                if (updatePostResultDto.getUpdatePostResultStatus()
