...
<template>
  <li :key="reply.id" class="reply-card">
    ...
    <ReplyEditor v-if="showReplyForm" :replyId="reply.id.toString()" :show-reply-form="showReplyFormWrapper" :refresh-replies="refreshReplies" />
    <button @click="showReplies = !showReplies">{{ showReplies ? "hide" : "show" }}</button>
